...
# # Day 2 Pre-class Assignment: Intro to Machine Learning 
# 
# 
...
# <img src="https://drive.google.com/uc?id=1gi6AKhfpA2XW9InP4iQ34lqJRGu7D8rb">
...
# Think about a siutation where you might want to classify some set of things using logistic regression. What is that set? What are the classes? And what kinds of features would you use to build that model?
