.PHONY: setup slides copy-slides complete update open serve-slides web

MARP = marp --theme slides/nordic.css --allow-local-files
DAYS = day-01-data day-02-classification day-03-regression day-04-modeling
