...
<li class="toctree-l1"><a class="reference internal" href="../../../../../../activities/02-classification-models-with-scikit-learn-student.html">Using KNN to classify objects with <code class="docutils literal notranslate"><span class="pre">sklearn</span></code> and <code class="docutils literal notranslate"><span class="pre">pandas</span></code></a></li>
</ul>
...
<li class="toctree-l1"><a class="reference internal" href="../../../../../../activities/02-classification-models-with-scikit-learn.html">Using KNN to classify objects with <code class="docutils literal notranslate"><span class="pre">sklearn</span></code> and <code class="docutils literal notranslate"><span class="pre">pandas</span></code> - solution</a></li>
</ul>
...
<div class="output text_plain highlight-myst-ansi notranslate"><div class="highlight"><pre><span></span>&lt;contextlib.ExitStack at 0xffff9c158050&gt;
</pre></div>
</div>
</div>
</div>
