...
<html lang="en" data-content_root="../../../../../../" >
  ...
  <head>
    ...
    <title>Content with notebooks &#8212; 2026 MSU REU Machine Learning Short Course</title>
...
<a class="navbar-brand logo" href="../../../../../../intro.html">
    ...
    <img src="../../../../../../_static/logo.png" class="logo__image only-light" alt="2026 MSU REU Machine Learning Short Course - Home"/>
    <script>document.write(`<img src="../../../../../../_static/logo.png" class="logo__image only-dark" alt="2026 MSU REU Machine Learning Short Course - Home"/>`);</script>
...
<li class="toctree-l1"><a class="reference internal" href="../../../../../../course_info/slides.html">Lecture Slides</a></li>
...
<ul class="nav bd-sidenav">
<li class="toctree-l1"><a class="reference internal" href="../../../../../../activities/01-exploring-data-with-pandas-student.html">Day 01: Exploring data with <code class="docutils literal notranslate"><span class="pre">pandas</span></code></a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../../activities/02-classification-models-with-scikit-learn-student.html">Day 02: Using KNN to classify objects with <code class="docutils literal notranslate"><span class="pre">sklearn</span></code> and <code class="docutils literal notranslate"><span class="pre">pandas</span></code></a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../../activities/03-regression-models-with-scikit-student.html">Day 03: Performing Regression with <code class="docutils literal notranslate"><span class="pre">scikit-learn</span></code></a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../../activities/04-modeling-project-student.html">Day 04: Modeling Project</a></li>
</ul>
<p aria-level="2" class="caption" role="heading"><span class="caption-text">Solutions</span></p>
<ul class="nav bd-sidenav">
<li class="toctree-l1"><a class="reference internal" href="../../../../../../activities/01-exploring-data-with-pandas.html">Day 01: Exploring data with <code class="docutils literal notranslate"><span class="pre">pandas</span></code> - solution</a></li>
...
<li class="toctree-l1"><a class="reference internal" href="../../../../../../activities/03-regression-models-with-scikit.html">Day 03: Performing Regression with <code class="docutils literal notranslate"><span class="pre">scikit-learn</span></code> - solution</a></li>
</ul>
<p aria-level="2" class="caption" role="heading"><span class="caption-text">Notes: Day 2 — Classification</span></p>
<ul class="nav bd-sidenav">
<li class="toctree-l1"><a class="reference internal" href="../../../../../../notes/methods_and_validation.html">Methods and Model Validation</a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../../notes/svm.html">Support Vector Machines</a></li>
</ul>
<p aria-level="2" class="caption" role="heading"><span class="caption-text">Notes: Day 3 — Regression &amp; Visualization</span></p>
<ul class="nav bd-sidenav">
...
<p aria-level="2" class="caption" role="heading"><span class="caption-text">Notes: Day 4 — Model Improvement</span></p>
<ul class="nav bd-sidenav">
...
<div class="dropdown dropdown-launch-buttons">
  ...
  <ul class="dropdown-menu">
      ...
      <li><a href="https://mybinder.org/v2/git/https%3A//github.com/dannycab/MSU_REU_ML_course/docs/_build/html/index.html/main?urlpath=lab/tree/.venv/lib/python3.13/site-packages/jupyter_book/book_template/notebooks.ipynb" target="_blank"
...
<span class="btn__text-container">Binder</span>
      ...
      <li><a href="https://jupyterhub.egr.msu.edu/hub/user-redirect/git-pull?repo=https%3A//github.com/dannycab/MSU_REU_ML_course/docs/_build/html/index.html&urlpath=lab/tree/index.html/.venv/lib/python3.13/site-packages/jupyter_book/book_template/notebooks.ipynb&branch=main" target="_blank"
   class="btn btn-sm dropdown-item"
...
<span class="btn__text-container">JupyterHub</span>
      ...
      <li><a href="https://colab.research.google.com/github/html/index.html/blob/main/.venv/lib/python3.13/site-packages/jupyter_book/book_template/notebooks.ipynb" target="_blank"
   class="btn btn-sm dropdown-item"
...
<div class="output text_plain highlight-myst-ansi notranslate"><div class="highlight"><pre><span></span>&lt;contextlib.ExitStack at 0x113e78690&gt;
</pre></div>
</div>
</div>
</div>
...
By Danny Caballero, Morten Hjorth-Jensen, Julie Butler, Jane Kim, Alia Valentine
  ...
  <p class="copyright">
      ...
      © Copyright 2021-2026, Michigan State University.
      <br/>
